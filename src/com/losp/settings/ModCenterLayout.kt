...
import com.losp.settings.fragments.*
...
class ModCenterLayout : SettingsPreferenceFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        requireActivity().setTitle(R.string.losp_modcenter_title)
    }
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.losp_settings, container, false)
    ...
    override fun getMetricsCategory(): Int =
        MetricsProto.MetricsEvent.LOSP_MODCENTER
