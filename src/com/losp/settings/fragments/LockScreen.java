...
import com.losp.settings.fragments.lockscreen.PulseSettings;
import com.losp.settings.fragments.lockscreen.MediaArtSettings;
import com.losp.settings.fragments.lockscreen.UdfpsAnimation;
import com.losp.settings.fragments.lockscreen.UdfpsIconPicker;
...
public class LockScreen extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.losp_settings_lockscreen);
        ...
        if (!hasFingerprint) {
            ...
            if (!Utils.isPackageInstalled(context, "com.losp.udfps.animations")) {
                gestCategory.removePreference(mUdfpsAnimations);
            }
            if (!Utils.isPackageInstalled(context, "com.losp.udfps.icons")) {
                gestCategory.removePreference(mUdfpsIcons);
            }
        }
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.losp_settings_lockscreen) {
